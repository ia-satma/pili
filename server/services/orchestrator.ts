...
export async function runOrchestrator(req: OrchestratorRequest): Promise<OrchestratorResponse> {
  ...
  const systemPromptLines = [
    ...
    "4. DATOS ESTRICTOS: Si un campo como 'Budget' (o cualquier otro campo financiero/estratégico) no está presente en el JSON proporcionado, indica explícitamente 'Data not available' en lugar de inferir o inventar un valor.",
    "5. IDIOMA: Responde SIEMPRE en espanol.",
    "6. FORMATO: Responde en JSON valido.",
    "",
    modeInstruction,
    "",
