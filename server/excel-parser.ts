...
const COLUMN_MAPPINGS: Record<string, ProjectField> = {
  ...
  "inversión": "capexTier",
  "inversion": "capexTier",
  "nivel de inversión": "capexTier",
  "nivel de inversion": "capexTier",
  "capex tier": "capexTier",
  "capex": "capexTier",
  "costo": "capexTier",

  "impacto financiero": "financialImpact",
  "financial impact": "financialImpact",
  "beneficio financiero": "financialImpact",
  "ingresos": "financialImpact",
  "revenue": "financialImpact",

  "alineación estratégica": "strategicFit",
  "alineacion estrategica": "strategicFit",
  "strategic fit": "strategicFit",
  "alineación": "strategicFit",
};
      ...
      for (const [key, value] of Object.entries(row)) {
        ...
        if (field) {
          switch (field) {
            ...
            case "strategicFit":
              (project as any)[field] = getString(value)?.toUpperCase() || null;
              break;
          }
        } else {
